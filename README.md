...
3. Add script from [index.js](https://github.com/Ltwoz/notcoin-bot/blob/main/index.js) into Violentmonkey
...
You can find it [here in index.js](https://github.com/Ltwoz/notcoin-bot/blob/main/index.js)
